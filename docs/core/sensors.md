...
| Sensor | Description |
| --------- | --------- |
| `battery_cycle_count` | The number of charge cycles completed by the battery. Requires Android 14 or later. Note: not all devices will report or update the cycle count. |
...
:::note
On Android 13 or earlier, you need to install and set up the [Health Connect app](https://play.google.com/store/apps/details?id=com.google.android.apps.healthdata) to use these sensors.
:::
